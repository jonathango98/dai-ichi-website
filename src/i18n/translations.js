export const translations = {
  id: {
    ...
    footer: {
      tagline: 'Precision Exhaust Engineering.\nDibuat di Indonesia sejak 1985.',
      navTitle: 'Navigasi',
    ...
    home: {
      ...
      productsTitle: 'TIGA MEREK, SATU STANDAR KUALITAS',
      productsSubtitle:
        'Dari OEM premium hingga custom performance — kami memiliki solusi knalpot untuk setiap kebutuhan Anda.',
      products: [
        {
          title: 'DAI-ICHI',
        ...
        },
        {
          ...
          tag: 'Value',
          description:
            'Knalpot harian yang handal dengan material Aluminized dan Galvanized Steel. Performa terpercaya, harga terjangkau, ready stock untuk semua model populer.',
          features: [
            'Aluminized & Galvanized Steel',
            'Ready Stock — Model Populer',
            'Harga Kompetitif',
            'Easy Installation',
            'Durabilitas Tinggi',
          ],
        ...
        {
          title: 'COBRA SPORT',
          tagline: 'Performance & Custom Fabrication',
          tag: 'Performance',
          description:
      ...
      productCta: 'Konsultasi Sekarang →',
      virtualShopLabel: 'Toko Virtual',
      virtualShopTitle: 'BELI ONLINE MELALUI PEGASUS KNALPOT',
      virtualShopBody:
        'Pesan produk dari ketiga lini merek kami secara online. Pilih pengiriman ke bengkel mitra terdekat untuk pemasangan profesional, atau langsung ke alamat Anda.',
      virtualShopCta: 'Kunjungi @pegasusknalpot',
      virtualShopWa: 'Chat WhatsApp',
      ...
      achievements: [
        ...
        { num: '100+', label: 'Bengkel Mitra' },
        { num: '50+', label: 'Kota di Indonesia' },
      ],
      techLabel: 'Keunggulan Teknis',
      techTitle: 'TEKNOLOGI FABRIKASI KELAS INDUSTRI',
      techSubtitle:
        'Setiap unit diproduksi menggunakan mesin presisi modern yang dioperasikan oleh tenaga ahli berpengalaman.',
      tech: [
        {
          icon: '⚡',
          title: 'Gas Cutting',
        ...
        },
        {
          ...
          title: 'MIG Welding',
          description:
            'Metal Inert Gas welding menghasilkan sambungan las yang kuat, rapat, dan tahan korosi. Setiap weld bead diperiksa secara visual untuk memastikan kualitas premium.',
        },
        {
          icon: '✨',
          title: 'Polishing Machine',
          description:
            'Proses polishing multi-tahap menghasilkan mirror finish berkualitas tinggi yang tidak hanya estetis namun juga meningkatkan ketahanan terhadap oksidasi.',
        },
        {
          icon: '🔩',
          title: 'Precision Bending',
          description:
            'Bending pipa presisi dengan radius kontrol untuk memastikan aliran gas buang yang optimal dan fitment sempurna pada setiap model kendaraan.',
        },
      ],
      ctaTitle: 'SIAP MENINGKATKAN PERFORMA KENDARAAN ANDA?',
      ctaBody:
    ...
    story: {
      ...
      heroSubtitle:
        'Sebuah perjalanan panjang — dari abu kebakaran di Jl Gajahmada hingga menjadi produsen knalpot terpercaya dengan tiga lini merek selama lebih dari 40 tahun.',
    ...
    contact: {
      metaTitle: 'Hubungi Kami — Dai Ichi Indonesia',
      metaDescription: 'Konsultasikan kebutuhan knalpot Anda. Hubungi kami via WhatsApp, Instagram, atau form konsultasi online.',
      heroBadge: 'Inquiry & Konsultasi',
      heroTitle1: 'KONSULTASI DENGAN',
      heroTitle2: 'AHLI FABRIKASI',
      heroSubtitle:
        'Ceritakan kebutuhan kendaraan Anda. Kami akan merekomendasikan solusi knalpot yang tepat — dari OEM replacement hingga custom performance build.',
      formTitle: 'Form Konsultasi',
      formIntro:
        'Isi formulir berikut dengan spesifikasi kendaraan atau kebutuhan custom order Anda. Semakin detail, semakin akurat rekomendasi kami.',
      fields: {
        name: 'Nama Lengkap',
        namePlaceholder: 'Yahya Go',
        email: 'Alamat Email',
        emailPlaceholder: 'yahya@email.com',
        whatsapp: 'Nomor WhatsApp',
        whatsappPlaceholder: '08123456789',
        zipcode: 'Kode Pos',
        zipcodePlaceholder: '60282',
        zipcodeHint: '(untuk referensi pengiriman)',
        message: 'Informasi & Detail Pesanan',
        messageHint: '(spesifikasi mobil, model knalpot, kebutuhan custom)',
        messagePlaceholder:
          'Contoh: Toyota Avanza 2019, mencari knalpot stainless full system. Atau: butuh custom cat-back Dai-ichi untuk Honda Civic FK8...',
      },
      submitBtn: 'Kirim Konsultasi →',
      disclaimer: '* Kolom wajib. Kami tidak akan membagikan data Anda kepada pihak ketiga.',
      errors: {
        name: 'Nama wajib diisi.',
        email: 'Email wajib diisi.',
        emailInvalid: 'Format email tidak valid.',
        whatsapp: 'Nomor WhatsApp wajib diisi.',
        message: 'Informasi / pesan wajib diisi.',
      },
      success: {
        title: 'Pesan Anda Terkirim!',
        body: (name) => `Terima kasih, ${name}. Tim ahli fabrikasi kami akan menghubungi Anda melalui email atau WhatsApp dalam waktu 1×24 jam kerja.`,
        btn: 'Kirim Pertanyaan Lain',
      },
  ...
  en: {
    ...
    footer: {
      tagline: 'Precision Exhaust Engineering.\nHandcrafted in Indonesia since 1985.',
      navTitle: 'Navigation',
    ...
    home: {
      ...
      productsTitle: 'THREE BRANDS, ONE QUALITY STANDARD',
      productsSubtitle:
        'From premium OEM to custom performance — we have an exhaust solution for every need.',
      products: [
        {
          title: 'DAI-ICHI',
          tagline: 'Premium OEM & Sport',
        ...
        },
        {
          ...
          tag: 'Value',
          description:
            'Reliable daily-use exhaust with Aluminized and Galvanized Steel. Trusted performance, competitive pricing, and ready stock for all popular models.',
          features: [
            'Aluminized & Galvanized Steel',
            'Ready Stock — Popular Models',
            'Competitive Pricing',
            'Easy Installation',
            'High Durability',
          ],
      ...
      productCta: 'Consult Now →',
      virtualShopLabel: 'Virtual Shop',
      virtualShopTitle: 'BUY ONLINE VIA PEGASUS KNALPOT',
      virtualShopBody:
        'Order products from all three of our brand lines online. Choose delivery to your nearest partnered mechanic shop for professional installation, or direct to your door.',
      virtualShopCta: 'Visit @pegasusknalpot',
      virtualShopWa: 'Chat on WhatsApp',
      ...
      achievements: [
        ...
        { num: '100+', label: 'Mechanic Partners' },
        { num: '50+', label: 'Cities in Indonesia' },
      ],
      techLabel: 'Technical Excellence',
      techTitle: 'INDUSTRY-GRADE FABRICATION TECHNOLOGY',
      techSubtitle:
        'Every unit is produced using modern precision machinery operated by experienced specialists.',
      tech: [
        {
          icon: '⚡',
          title: 'Gas Cutting',
        ...
        },
        {
          ...
          title: 'MIG Welding',
          description:
            'Metal Inert Gas welding produces strong, gas-tight, corrosion-resistant joints. Every weld bead is visually inspected to guarantee premium quality.',
        },
        {
          icon: '✨',
          title: 'Polishing Machine',
          description:
            'Multi-stage polishing delivers a high-quality mirror finish that is not only visually striking but also enhances resistance to oxidation.',
        },
        {
          icon: '🔩',
          title: 'Precision Bending',
          description:
            'Precision pipe bending with controlled radii ensures optimal exhaust gas flow and perfect fitment for every vehicle model.',
        },
      ],
      ctaTitle: 'READY TO ELEVATE YOUR VEHICLE\'S PERFORMANCE?',
      ctaBody:
    ...
    story: {
      ...
      metaDescription: 'The story behind Dai Ichi Indonesia: from a 1985 Sidoarjo workshop to Indonesia\'s trusted exhaust manufacturer.',
      heroBadge: 'Heritage & History',
      heroTitle1: 'THE STORY BEHIND',
      heroTitle2: 'NUMBER ONE',
      heroSubtitle:
        'A long journey — from the ashes of a fire on Jl. Gajahmada to becoming a trusted exhaust manufacturer with three brand lines spanning over 40 years.',
    ...
    contact: {
      metaTitle: 'Contact Us — Dai Ichi Indonesia',
      metaDescription: 'Consult with a fabrication expert. Reach us via WhatsApp, Instagram, or our online consultation form.',
      heroBadge: 'Inquiry & Consultation',
      heroTitle1: 'CONSULT WITH A',
      heroTitle2: 'FABRICATION EXPERT',
      heroSubtitle:
        'Tell us about your vehicle\'s needs. We\'ll recommend the right exhaust solution — from OEM replacement to a full custom performance build.',
      formTitle: 'Consultation Form',
      formIntro:
        'Fill in the form below with your vehicle specifications or custom order requirements. The more detail you provide, the more accurate our recommendation will be.',
      fields: {
        name: 'Full Name',
        namePlaceholder: 'Yahya Go',
        email: 'Email Address',
        ...
        zipcodePlaceholder: '60282',
        zipcodeHint: '(for shipping reference)',
        message: 'Information & Order Details',
        messageHint: '(car specs, exhaust model, custom requirements)',
        messagePlaceholder:
          'Example: 2019 Toyota Avanza, looking for a full stainless system. Or: need a custom Dai-ichi cat-back for a Honda Civic FK8...',
      },
      submitBtn: 'Send Consultation →',
      disclaimer: '* Required fields. We will never share your data with third parties.',
      errors: {
        name: 'Full name is required.',
        email: 'Email address is required.',
        emailInvalid: 'Please enter a valid email address.',
        whatsapp: 'WhatsApp number is required.',
        message: 'Please provide your inquiry details.',
      },
      success: {
        title: 'Message Sent!',
        body: (name) => `Thank you, ${name}. Our fabrication team will contact you by email or WhatsApp within 1 business day.`,
        btn: 'Send Another Inquiry',
      },
